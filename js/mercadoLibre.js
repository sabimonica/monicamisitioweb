class Automovil {
    constructor(marca, modelo, precio, anyo, ciudad, kilometros, imagen) {
        ...
        this.imagen = imagen; // Agregar atributo para la imagen
    }
}

let autos = [
    new Automovil("Toyota", "TXL", 190000000, 2021, "Pitalito - Huila", 35420, "img/toyota.png"),
    new Automovil("Chevrolet", "Cruze", 170000000, 2020, "Medellín - Antioquia", 45000, "img/carro.png"),
    new Automovil("Nissan", "Murano", 118000000, 2021, "Bogotá - Cundinamarca", 46000, "img/nissan.png")
];
